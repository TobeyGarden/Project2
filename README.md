# Project2
Answering pertinent questions on Consumer Price Index juxtaposed to the two largest economic recessions within the past 20 years in the US with Tableau.
...
2) Daniel Pritchard [@dcpritch](https://github.com/TobeyGarden/Project2/edit/main/README.md)
3) Ian Arnold [@ian-uga](https://github.com/TobeyGarden/Project2/edit/main/README.md)
4) Austin Zeiller [@Austinz7303](https://github.com/TobeyGarden/Project2/edit/main/README.md)
5) Owen Herring [@Oherring22](https://github.com/TobeyGarden/Project2/edit/main/README.md)
...
Our dataset contains 3 fields; the Consumer Price Index for each food item, the year that each Consumer Price Index was record from 1974 - 2023, and the Percent Change between each year. In terms of dimensions, the rows for the project are Consumer Price Index and Percent change and there is one column dimension containing years. 
...
**Question 1 Visualization and Analysis**
...
Our analysis reveals how major economic events like the Great Recession and the COVID-19 pandemic impacted food prices in significantly different ways. While both crises disrupted American life and created widespread financial uncertainty, their effects on consumer behavior and supply chains were starkly different, resulting in opposite trends in food prices. The COVID-19 pandemic triggered panic buying and supply chain disruptions, leading to sharp price increases—especially in 2022. In contrast, the Great Recession saw reduced consumer spending and lower demand, driving food prices down.

When examining specific categories of healthy foods, most items—such as dairy, fresh fruits, and fresh vegetables—showed remarkable stability during these shocks, demonstrating resilience to economic volatility. However, eggs stood out as highly volatile, reflecting their unique role in consumer demand and production constraints. This distinction underscores how certain staple items can be far more sensitive to sudden changes in behavior and supply conditions.

Together, these insights suggest that while overall food prices can be heavily influenced by macroeconomic conditions, some categories of food—especially those with less flexible production like eggs—are particularly vulnerable. This information could be vital for policymakers and supply chain managers seeking to enhance food system resilience in future crises.
